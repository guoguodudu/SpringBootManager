 ...
 * </html>
 */
package com.phdua.manager.designpattern.pattern.action.observer;

import com.phdua.manager.designpattern.pattern.action.observer.observerAbs.Subject;
import com.phdua.manager.designpattern.pattern.action.observer.observerIml.DiaoSi;
import com.phdua.manager.designpattern.pattern.action.observer.observerIml.GaoFuShuai;
import com.phdua.manager.designpattern.pattern.action.observer.observerIml.NvShen;
