 ...
 * </html>
 */
package com.phdua.manager.designpattern.pattern.action.state.absState;

import com.phdua.manager.designpattern.pattern.action.state.allState.Close;
import com.phdua.manager.designpattern.pattern.action.state.allState.Open;
import com.phdua.manager.designpattern.pattern.action.state.allState.Run;
import com.phdua.manager.designpattern.pattern.action.state.allState.Stop;
