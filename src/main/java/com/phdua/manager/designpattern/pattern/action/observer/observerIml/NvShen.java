 ...
 * </html>
 */
package com.phdua.manager.designpattern.pattern.action.observer.observerIml;


import java.util.ArrayList;
import java.util.List;

import com.phdua.manager.designpattern.pattern.action.observer.observerAbs.Observer;
